...
public class RobotContainer {
    ...
    new JoystickButton(driverJoytick, Button.kRightBumper.value).whileTrue(new  ShooterCmd(shooter, 0.4, -0.42));
    ...
    new JoystickButton(driverJoytick, Button.kLeftBumper.value).whileTrue(new BeltCmd(belt, 0.6));
